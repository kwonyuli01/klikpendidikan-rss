#!/usr/bin/env python3
"""
KlikPendidikan.id RSS Feed Scraper - News
======================================================
Menggunakan Playwright (headless browser) untuk bypass Cloudflare.
Scrape halaman news + konten artikel lengkap (multi-page 1-7).
...
BASE_URL = "https://www.klikpendidikan.id"
CATEGORY_URL = "https://www.klikpendidikan.id/news"

MAX_ARTICLES = 20

FEED_TITLE = "KlikPendidikan.id - News"
FEED_DESCRIPTION = "RSS Feed News dari klikpendidikan.id dengan konten artikel lengkap"
FEED_LINK = "https://www.klikpendidikan.id/news"
...
def parse_list_page(url):
    ...
    if headline:
        ...
        if href and title and '/news/' in href:
...
<rss version="2.0"
  ...
  <channel>
    ...
    <generator>KlikPendidikan RSS Scraper - Playwright (GitHub Actions)</generator>
'''
...
def main():
    """Fungsi utama."""
    print("=" * 60)
    print("  KlikPendidikan.id RSS Scraper - News (Playwright)")
    print("=" * 60)
